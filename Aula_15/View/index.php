...
$botao_cor = $bebida_selecionada ? '#FF83C1' : '#FF83C1';
...
<body>
    ...
    <div class="container">
        ...
        <div class="form-area" style="border-color: <?php echo $bebida_selecionada ? '#000000' : '#000000'; ?>;">
            ...
            <form method="POST">
                ...
                <?php if ($bebida_selecionada): ?>
                    <a href="index.php" style="padding: 10px; background-color: #FFC5D3; color: #FF83C1; border-radius: 4px; cursor: pointer; text-decoration: none;">Cancelar Edição</a>
                <?php endif; ?>
            </form>
        </div>
            ...
            <table border="1" width="100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="?editar=<?php echo urlencode($bebida->getNome()); ?>" style="background-color: #FF83C1; color: white; border-radius: 4px; cursor: pointer; padding: 5px ; text-decoration: none; margin-right: 5px;">Editar</a>
                            
                            <form method="POST" style="display: inline;">
                                <input type="hidden" name="acao" value="deletar">
                                <input type="hidden" name="nome" value="<?php echo htmlspecialchars($bebida->getNome()); ?>">
                                <button type="submit" style="background-color: #FFC5D3; color: #FF83C1; border: #FF83C1; border-radius:  4px; cursor: pointer; padding: 5px;">Excluir</button>
                            </form>
                        </td>
                    </tr>
                    <?php endforeach; ?>
